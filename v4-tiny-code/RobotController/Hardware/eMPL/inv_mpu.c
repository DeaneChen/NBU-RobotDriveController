...
//#define log_i       printf
//#define log_e       printf
#define MPU6050_NOT_USE_LOG
#define MPU6500_NOT_USE_LOG
...
int mpu_reg_dump(void)
{
    ...
    for (ii = 0; ii < st.hw->num_reg; ii++) {
        ...
        if (i2c_read(st.hw->addr, ii, 1, &data))
            return -1;
        #if !defined MPU6050_NOT_USE_LOG || !defined MPU6500_NOT_USE_LOG
            log_i("%#5x: %#5x\r\n", ii, data);
        #endif
    }
    return 0;
...
int mpu_init(struct int_param_s *int_param)
{
    ...
    if (rev) {
        ...
        if (rev == 1)
            ...
            #if !defined MPU6050_NOT_USE_LOG
...
#define MPU6500_MEM_REV_ADDR    (0x17)
    ...
    if (rev == 0x1 || rev == 0x2)
        ...
        #if !defined MPU6500_NOT_USE_LOG
        log_e("Unsupported software product rev %d.\n", rev);
        #endif
        return -1;
    }
